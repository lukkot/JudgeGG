...
public class PlayerViewDataComparatorTest {
	...
	public void shouldTestPlayerStartNumberOrder() {
		PlayerViewDataComparator playerViewDataComparator = new PlayerViewDataComparator(ComparisonType.START_NUMBER);
		
		int resultP1P2 = playerViewDataComparator.compare(p1, p2);
		int resultP2P1 = playerViewDataComparator.compare(p2, p1);
		int resultP1P1 = playerViewDataComparator.compare(p1, p1);
	...
	public void shouldTestPlayerRound1Order() {
		PlayerViewDataComparator playerViewDataComparator = new PlayerViewDataComparator(ComparisonType.ROUND_1);
		
		int resultP1P2 = playerViewDataComparator.compare(p1, p2);
		int resultP2P1 = playerViewDataComparator.compare(p2, p1);
		int resultP1P1 = playerViewDataComparator.compare(p1, p1);
		int resultP3P2 = playerViewDataComparator.compare(p3, p2);
	...
	public void shouldTestPlayerRoundBestOrder() {
		PlayerViewDataComparator playerViewDataComparator = new PlayerViewDataComparator(ComparisonType.ROUND_BEST);
