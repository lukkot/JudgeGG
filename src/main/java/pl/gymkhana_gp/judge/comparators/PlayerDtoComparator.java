...
public class PlayerDtoComparator implements Comparator<PlayerViewData> {
	...
	public PlayerDtoComparator(ComparisonType comparisonType) {
		this(comparisonType, false);
	}

	public PlayerDtoComparator(ComparisonType comparisonType, boolean reversed) {
